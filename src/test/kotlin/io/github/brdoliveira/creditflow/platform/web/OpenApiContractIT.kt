...
class OpenApiContractIT {
    ...
    fun openApiDescribesRelevantOperationsAndContracts() {
        ...
        listOf("/api/v1/credit-evaluations:", "/api/v1/credit-evaluations/{evaluationId}:", "/api/v1/credit-evaluations/report.pdf:", "Idempotency-Key", "Idempotent-Replay", "X-Correlation-ID", "credit:read", "credit:write", "credit:report", "credit:admin", "maskedCpf:", "fieldErrors:", "page:", "size:", "sort:").forEach { expected ->
