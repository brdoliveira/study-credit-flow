...
| Carga nominal | `./scripts/run-load-test.ps1` | Aprovado: 10.000,2/min; p99 334,781119 ms; erro técnico 0%; 50.002 nominais; 0 descartadas | `2026-08-16` | `f9aa3b37569faa0f0de0dc6a1aee14c4e6e7c37d` |
