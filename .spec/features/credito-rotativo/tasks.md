...
## T-001 — Preparar projeto Kotlin e testes de especificação [pendente]
...
## T-004 — Implementar caso de uso de avaliação [pendente]
...
## T-005 — Implementar API REST e contrato de erros [pendente]
...
## T-006 — Implementar persistência PostgreSQL e auditoria [pendente]
...
## T-007 — Implementar idempotência concorrente [pendente]
...
## T-008 — Implementar Outbox, publicação e consumo idempotente [pendente]
...
## T-009 — Implementar autenticação e autorização [pendente]
...
## T-011 — Implementar frontend demonstrativo [pendente]
...
## T-013 — Preparar execução local em containers [pendente]
...
## T-014 — Criar pipeline de CI e gates [pendente]
...
## T-015 — Criar e documentar teste de carga [pendente]
