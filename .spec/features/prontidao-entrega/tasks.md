...
## T-017 — Implementar login OIDC pelo BFF [pendente]
...
## T-018 — Corrigir a semântica HTTP da idempotência [pendente]
...
## T-019 — Conectar Outbox PostgreSQL ao Kafka [pendente]
...
## T-020 — Implementar consumidor Kafka idempotente [pendente]
...
## T-021 — Integrar métricas e health checks ao runtime [pendente]
...
## T-022 — Criar prova ponta a ponta do Docker Compose [pendente]
...
## T-023 — Executar e registrar o ensaio de carga [pendente]
...
## T-024 — Tornar CI e supply chain reproduzíveis [pendente]
...
## T-025 — Publicar e testar o contrato OpenAPI [pendente]
...
## T-026 — Criar infraestrutura AWS de referência [pendente]
...
## T-027 — Consolidar roteiro e índice de evidências [pendente]
