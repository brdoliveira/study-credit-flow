...
## T-036 — Impor todas as fronteiras arquiteturais [pendente]
...
## T-037 — Consolidar a organização por feature [pendente]
...
## T-038 — Tipar o filtro de decisão de ponta a ponta [pendente]
...
## T-039 — Tornar a classe Kotlin a fonte do evento da outbox [pendente]
...
## T-040 — Atualizar documentação e provar compatibilidade [pendente]
